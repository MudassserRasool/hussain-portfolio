    ...
    <div className="flex justify-center">
      <div>
        <center className="">
          ...
          <div className="w-4/5 text-white text-md  md:w-[610px] mt-6 mb-2 ml-4 md:ml-24">
        ...
        <div className=" text-white grid max-w-screen-xl px-4 py-8 mx-auto ">
          <div className="flex flex-col md:flex-row  gap-72 h-42 mt-10">
            ...
            <div className=" pt-10n">
              <h1 className="text-md pl:2 md:pl-10">
              ...
              <div className="-translate-y-12 md:translate-x-10">
                ...
                <p className="md:text-md w-4/5 text-white md:w-[400px] text-md">
          ...
          <div className="flex  flex-col-reverse md:flex-row mb-10 md:h-24 mt-10 gap-72">
            <div>
              <div className="ml-6 overflow-hidden">
                <h1 className="text-md pt-5 text-white">
                ...
                <div className="-translate-y-10 ">
                  ...
                  <h1 className="text-lg font-semibold md:mb-1">
                    {data('technology.title')}
                  </h1>
                  <p className="md:text-md w-4/5 text-white md:w-[350px]">
          ...
          <div className="flex flex-col md:flex-row  md:h-64 mt-20 gap-72">
            ...
            <div className=" pt-10 overflow-hidden">
              <h1 className="text-md  md:pl-5">{data('process.field')}</h1>
              <div className="-translate-y-14 translate-x-4 ">
                <span className="opacity-20 text-gray-400 text-7xl font-bold">
                ...
                <p className="md:text-md w-4/5 text-white md:w-[400px]">
          ...
          <div className="flex flex-col md:flex-row  md:h-64 mt-20 gap-72">
            ...
            />
            <div className=" pt-10 overflow-hidden">
              <h1 className="text-md  md:pl-5">{data('delivery.field')}</h1>
